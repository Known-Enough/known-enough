...
Current scheduling (September 23): both users follow the same [project-wide priority queue](task-board.md), with one active task at a time. A/B IDs and personal handoff filenames do not assign ownership. G01 is DONE after human acceptance. B04's bounded R1/P1 and R2/P2 corrections at `bfeb448` received independent [B04.5 follow-up PASS](reviews/B04.5.md), with fresh focused tests 23/23. The review claim is released and both findings are closed. B04 remains PAUSED with A/Ricardo retaining ownership for resumption; its midpoint review block is released. Live identity/session, IAM, DynamoDB and G02 gates remain open. Actual worker model was GPT-6 Codex with variant/effort unavailable, so the `gpt-6-sol` / high target is not claimed as verified. A05 mock preparation remains REVIEW pending separate human acceptance. [T01](tasks/T01.md) and [T02](tasks/T02.md) remain later AI-extension work.

Earlier handoff, 2026-09-22 (superseded by the current status above): **A02.5/G01 synchronized repairs, REVIEW for human acceptance.** User explicitly authorized commit/push. Reviewed repairs are preserved in `d042d8f`; integration includes published `8371e7b`, shared-pool policy, readiness/debug changes and tutorial. [G01 combined artifact and evidence](reviews/G01.md) records conflict decisions, exact hashes, fresh checks and independent review. No B04 implementation or new task claim was recorded at that time. Earlier paragraphs retain historical context.

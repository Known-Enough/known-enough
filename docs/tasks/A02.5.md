...
- Current gate: [A03.5 CHANGES_REQUESTED](../reviews/A03.5.md); current review on `c79faeb` closes R1/R3/R4 but leaves R2/R5 and V1 open. Requires a fresh PASS plus the existing B03 prerequisite.

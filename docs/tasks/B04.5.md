...
- Status: READY.
- Claim: Unclaimed; B04 is paused after its first Cognito identity slice and design. Review only that named artifact, then hand findings to its implementation owner.

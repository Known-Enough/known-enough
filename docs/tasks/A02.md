...
- A03.5 follow-up: [CHANGES_REQUESTED on `df1e876`](../reviews/A03.5.md). Owner A must address R1–R5: receipt-only acceptance, ignored availability selection, omitted exception policy, lost retry envelope for invalid JSON results, and missing explicit input-confirmation preparation. No fix is implemented or newly claimed by the reviewer; keep REVIEW pending fixes and independent follow-up.

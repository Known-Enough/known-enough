...
- Owner/status: A — READY. B may claim this unclaimed READY A task only after finishing or safely pausing B's active task, with an available diff/commit and a logged handoff; no duplicate writers.

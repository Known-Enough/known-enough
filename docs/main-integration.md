...
Follow-up review of `2dd036a` found a bounded export/lock issue, corrected in `a058cc5` with a fresh independent PASS. B04’s later acceptance audit found no room-invitation route for the “invite replay” criterion, so B04 added subject-bound single-use issuance/redemption in `13707c2`. Independent B04.5 follow-up requested P2 R11/R12; B04 fixed scope enumeration and deterministic capacity mapping in `f6b93bc`. That exact diff is PAUSED for fresh independent B04.5 follow-up. No managed-service/live acceptance, deployment or human acceptance is claimed; these correction commits remain local and unpushed.
